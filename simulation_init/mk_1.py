...
batch_name = '1_PS_off'  # Organize all simulation runs from this batch into one folder
base_dir = './' + batch_name
    ...
    for deb in debye_lengths:
        for sa in subunit_attractions:
            for pss in PS_spacings:
                ...
                copy('./assembled_capsid_1.gsd', os.path.join(base_dir, run_dir, 'assembled_capsid.gsd'))
